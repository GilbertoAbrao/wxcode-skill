---
name: wxcode:research-phase
description: Research how to implement a phase (standalone - usually use /wxcode:plan-phase instead)
argument-hint: "[phase]"
allowed-tools:
  - Read
  - Bash
...
**Note:** This is a standalone research command. For most workflows, use `/wxcode:plan-phase` which integrates research automatically.
...
## 4. Spawn wxcode-phase-researcher Agent
...
<downstream_consumer>
Your RESEARCH.md will be loaded by `/wxcode:plan-phase` which uses specific sections:
...
- [ ] wxcode-phase-researcher spawned with context
