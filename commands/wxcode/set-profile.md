---
name: set-profile
description: Switch model profile for WXCODE agents (quality/balanced/budget)
arguments:
  - name: profile
...
```
Error: No WXCODE project found.
Run /wxcode:new-project first to initialize a project.
```
...
| Agent | Model |
|-------|-------|
| wxcode-planner | sonnet |
| wxcode-executor | sonnet |
| wxcode-verifier | haiku |
| ... | ... |
```

**Switch to quality mode:**
```
/wxcode:set-profile quality
...
|-------|-------|
| wxcode-planner | opus |
| wxcode-executor | opus |
| wxcode-verifier | sonnet |
| ... | ... |
```
