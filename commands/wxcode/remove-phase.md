...
- Example: `/wxcode:remove-phase 17` → phase = 17
- Example: `/wxcode:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /wxcode:remove-phase <phase-number>
Example: /wxcode:remove-phase 17
```
...
To abandon current work, use /wxcode:pause-work instead.
```
...
Would you like to:
- `/wxcode:progress` — see updated roadmap status
