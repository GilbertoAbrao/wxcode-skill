---
name: wxcode:plan-milestone-gaps
...
<objective>
Create all phases necessary to close gaps identified by `/wxcode:audit-milestone`.

Reads MILESTONE-AUDIT.md, groups gaps into logical phases, creates phase entries in ROADMAP.md, and offers to plan each phase.

One command creates all fix phases — no manual `/wxcode:add-phase` per gap.
</objective>

<execution_context>
<!-- Spawns wxcode-planner agent which has all planning expertise baked in -->
</execution_context>
...
**At command end:**
```
<!-- WXCODE:NEXT_ACTION:{"command":"execute-phase","args":"","description":"Execute gap closure","priority":"recommended"} -->
```
</structured_output>
...
```
No audit gaps found. Run `/wxcode:audit-milestone` first.
```
...
**Also available:**
- `/wxcode:execute-phase {N}` — if plans already exist
...
`/wxcode:audit-milestone` — re-audit to verify gaps closed
`/wxcode:complete-milestone {version}` — archive when audit passes
```
...
- [ ] Changes committed
- [ ] User knows to run `/wxcode:plan-phase` next
</success_criteria>
