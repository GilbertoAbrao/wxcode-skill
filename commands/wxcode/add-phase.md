...
- Example: `/wxcode:add-phase Add authentication` → description = "Add authentication"
- Example: `/wxcode:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /wxcode:add-phase <description>
Example: /wxcode:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /wxcode:plan-phase {N} to break down)
...
**Also available:**
- `/wxcode:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /wxcode:insert-phase)
- Don't create plans yet (that's /wxcode:plan-phase)
