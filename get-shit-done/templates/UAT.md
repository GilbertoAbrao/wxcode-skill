...
- This section feeds directly into /wxcode:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /wxcode:plan-phase --gaps with root causes
...
**Creation:** When /wxcode:verify-work starts new session
