...
Exit skill and invoke SlashCommand("/wxcode:plan-phase [X+1]")
...
**Also available:**
- `/wxcode:discuss-phase [X+1]` — gather context first
- `/wxcode:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/wxcode:complete-milestone {version}")
