# Bug Report - WXCODE Codebase Review
...
**File:** `hooks/wxcode-statusline.js:51-54`
**Severity:** High
...
**Files:**
- `wxcode/workflows/execute-phase.md:20`
- `commands/gsd/execute-phase.md:45`
- `wxcode/workflows/execute-phase.md:62`
- `agents/wxcode-executor.md:47`
...
**File:** `wxcode/workflows/execute-phase.md:100-103`
**Severity:** Low
**Type:** Shell safety
...
**File:** `agents/wxcode-executor.md:69`
**Severity:** Low
...
**Examples:**
- `hooks/wxcode-statusline.js:49` - hardcoded `~/.claude/todos`
- `hooks/wxcode-check-update.js:12` - hardcoded `~/.claude/`
