...
<execution_context>
@~/.claude/wxcode-skill/workflows/execute-plan.md
@~/.claude/wxcode-skill/templates/summary.md
[If plan contains checkpoint tasks (type="checkpoint:*"), add:]
@~/.claude/wxcode-skill/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @~/.claude/wxcode-skill/references/checkpoints.md -->
...
See `~/.claude/wxcode-skill/references/tdd.md` for TDD plan structure.
...
See `~/.claude/wxcode-skill/templates/user-setup.md` for full schema and examples
...
See `~/.claude/wxcode-skill/workflows/verify-phase.md` for verification logic.
