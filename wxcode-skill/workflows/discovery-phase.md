...
See ~/.claude/wxcode-skill/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/wxcode-skill/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/wxcode-skill/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/wxcode-skill/templates/discovery.md
...
Use ~/.claude/wxcode-skill/templates/discovery.md.
