...
<required_reading>
@~/.claude/wxcode-skill/references/verification-patterns.md
@~/.claude/wxcode-skill/templates/verification-report.md
</required_reading>
...
See ~/.claude/wxcode-skill/templates/verification-report.md for complete template.
</step>
