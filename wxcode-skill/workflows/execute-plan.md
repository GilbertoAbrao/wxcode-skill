...
@~/.claude/wxcode-skill/references/git-integration.md
</required_reading>
...
See ~/.claude/wxcode-skill/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `~/.claude/wxcode-skill/templates/user-setup.md`.
...
Use ~/.claude/wxcode-skill/templates/summary.md for structure.
